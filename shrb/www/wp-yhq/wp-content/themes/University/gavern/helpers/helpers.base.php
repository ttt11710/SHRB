...
if(!function_exists('gk_str_replace_once')) { 
 	/**
 	 *
 	 ...
 	 *
 	 **/
	function gk_str_replace_once($needle , $replace , $haystack){
...
if(!function_exists('gk_get_current_page_url')) {
	/**
	 *
	 ...
	 *
	 **/
	function gk_get_current_page_url() {
		// start with the HTTP
		$pageURL = 'http';
		// check for the HTTPS
