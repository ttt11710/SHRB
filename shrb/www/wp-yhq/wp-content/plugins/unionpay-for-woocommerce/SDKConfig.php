...
// 签名证书路径
const SDK_SIGN_CERT_PATH = 'key/bankcomm.pfx';

// 签名证书密码
 const SDK_SIGN_CERT_PWD = 'RY2yq3';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://martuedev.gchu.cn/yl/FrontReceive.php';
// 后台通知地址 (商户自行配置通知地址)
const SDK_BACK_NOTIFY_URL = 'http://martuedev.gchu.cn/yl/BackReceive.php';
