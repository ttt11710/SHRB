		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo date('Y年m月d日.', $item['date_c']) ?></td>
					<td><?php echo date('Y年m月d日', $item['date_m']) ?></td>
				</tr>
				<?php endforeach; ?>
				<?php endif; ?>
				<?php if(empty($sliders)) : ?>
			...
			<tbody>
				<tr>
					...
					<td class="desc">
						...
						<?php _e('要接收自动更新，您需要输入您的项目购买代码。您的CodeCanyon下载页面上，你可以找到它，只需点击“下载”按钮，并选择“牌照证书”选项。这将下载一个文本文件，其中包含您的申购代码。', 'LayerSlider') ?>
					</td>
				</tr>
			</tbody>
			<tfoot>
