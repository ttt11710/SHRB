    ...
    $(document).ready(function(){
        ...
        btn.click(function(){
            ...
            if(span.length==3 && stockFlag){
                ...
                $.get("<?php echo admin_url('admin-ajax.php');?>?action=get_flashSale_create_order&flashSale_id="+flashSale_id+"&choose_color="+g_color+"&choose_size="+g_size+"&choose_mode="+g_mode,function(data){
                    $.closeLoading();
                    var group_msg=data;
    ...
    <div id="detail" class="">
        ...
        <div class="content">
            ...
            <div class="price pure-g ft17">
                <div class="pure-u-2-5 fc5">商品原价<br/><span class="ft21"><del id="cost">￥<?php echo $pb_flashSale_product->get_variation_regular_price('max');?></del></span></div>
