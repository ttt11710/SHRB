...
<div class="gkWrap" id="gkMainWrap" data-theme="<?php echo GKTPLNAME; ?>">	
	<h1>
		<big><?php echo $gk_tpl->full_name; ?></big><small><?php _e('Based on the Gavern WP framework', GKTPLNAME); ?><span><?php echo __('Version: ', GKTPLNAME) . '<strong>' . $gk_tpl->version . '</strong>'; ?></span></small>
	
		<a href="customize.php?theme=<?php echo $gk_tpl->full_name; ?>" title="<?php _e('Customize theme', GKTPLNAME); ?>"><?php _e('Customize theme', GKTPLNAME); ?></a>
