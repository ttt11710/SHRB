			...
			<tbody class="ls-slide-options">
				...
				<tr>
					...
					<td>
						...
						<button class="button ls-select-transitions new" data-help="<?php _e('You can select your desired slide transitions by clicking on this button.', 'LayerSlider') ?>">选择过渡效果</button>
					</td>
				...
				<tr>
					<td class="ls-preview-td">
						<div class="ls-preview-wrapper">
							...
							<button class="button ls-preview-button"><?php _e('进入预览', 'LayerSlider') ?></button>
						</div>
					</td>
				</tr>
			</tbody>
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td class="desc"><?php _e('当您使用一个响应或百分比尺寸为滑块，它会回应的父元素的大小变化。使用此选项，您可以绕过这个的行为和LayerSlider将全宽滑块。', 'LayerSlider') ?></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="desc">(px) <?php _e("如果您使用的是全宽滑块，你想避免在整个视口水平伸展层，此功能非常有用。只要指定一个自定义的宽度以像素为单位，将创建一个滑块，将您的内容放到这个中心的内部区域。注意，此功能只使用了像素定位的层，但你仍然可以使用该值'50％'如果你想居中的位置。", "LayerSlider") ?></td>
						</tr>
					</tbody>
					<thead>
						<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td class="desc"><?php _e("如果你启用了“自动播放”选项，“自动”值表示，幻灯片将暂停，直到视频播放完毕后，它会继续。 '启用'值表示，将停止播放幻灯片，并不会恢复后的视频已经播放。", "LayerSlider") ?></td>
						</tr>
						<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td class="desc"><?php _e('LayerSlider背景颜色。您可以使用所有的CSS的方法，如六色，RGB（R，G，B）的方法，色彩的名字，等等。注意，滑动与背景将覆盖全球的背景图片。', 'LayerSlider') ?></td>
						</tr>
						<tr>
							...
							<td class="desc"><?php _e('LayerSlider的背景图像。这将是一个固定的背景图像默认情况下LayerSlider。注意，与背景滑动将覆盖全球的背景图片。', 'LayerSlider') ?></td>
						</tr>
						<tr>
						...
						<tbody class="ls-slide-options">
							...
							<tr>
								...
								<td>
									...
									<button class="button ls-select-transitions new<?php echo !isset($layer['properties']['new_transitions']) ? ' ls-hidden' : '' ?>" data-help="<?php _e('You can select your desired slide transitions by clicking on this button.', 'LayerSlider') ?>">选择过渡效果</button>
								</td>
