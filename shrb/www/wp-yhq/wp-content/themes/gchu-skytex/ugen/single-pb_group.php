    ...
    $(document).ready(function(){
        ...
        btn.click(function(){
            ...
            // if(span.length==3 && stockFlag){
                ...
                $.get("<?php echo admin_url('admin-ajax.php');?>?action=get_group_create_order&group_id="+group_id+"&post_type=<?php echo get_post_type();?>",function(data){
                    $.closeLoading();
                    var group_msg=data;
    ...
    <div id="detail" class="">
        ...
        <div class="content">
            ...
            <div class="price pure-g ft17">
                <div class="pure-u-2-5 fc5">商品原价<br/><span class="ft21"><del id="cost"><?php echo $pb_group_product->get_price_html();?></del></span></div>
