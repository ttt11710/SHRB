				...
				<tr>
					<td colspan="4">
						...
						<div class="ls-builder-preview-button">
							<button class="button">进入预览</button>
						</div>
					</td>
				</tr>
			</tbody>
				...
				<tr>
					<td colspan="4">
						...
						<p class="ls-builder-checkbox">
							<label><input type="checkbox" class="ls-builder-collapse-toggle"> 启用</label>
						</p>
					</td>
				</tr>
			</thead>
					...
					<td colspan="4">
						...
						<p class="ls-tr-add-property">
							...
							<select>
								...
								<option value="rotateY,90"><?php _e('Y轴旋转', 'LayerSlider') ?></option>
		...
		<table class="ls-box ls-tr-settings bottomborder">
			...
			<tbody class="transition">
				...
				<tr>
					...
					<td class="right"><?php _e('Y轴旋转', 'LayerSlider') ?></td>
							...
							<thead>
								<tr>
									<td colspan="4">
										...
										<p class="ls-builder-checkbox">
											<label><input type="checkbox"<?php echo $checkboxProp ?> class="ls-builder-collapse-toggle"> 启用</label>
										</p>
									</td>
								</tr>
							</thead>
