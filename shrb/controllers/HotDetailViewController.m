...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.hotImageView.image = [UIImage imageNamed:[NSString stringWithFormat:@"%@.jpg",[[_data objectAtIndex:storeNum] objectForKey:@"storeName"]]];
    cell.detailView.text = [[_data objectAtIndex:storeNum] objectForKey:@"detail"];
    return cell;
}
